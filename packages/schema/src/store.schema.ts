...
const storeSchema = z.object({
  ...
  free_delivery_after: z.number().optional(),
});
const storeUpdateSchema = storeSchema
  .partial()
...
export type StoreSchemaTypes = z.infer<typeof storeSchema>;
export { storeSchema, storeUpdateSchema, StoreAddressSchema };
